    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (expression.Contains(")"))
            {
                for (int i = 0; i < expression.Length; i++)
                {
                    ...
                    else if (ch == ')')
                    {
                        ...
                        if (sbNumber2.Length > 0)
                        {
                            ...
                            int x = int.Parse(sbNumber1.ToString());
                            int y = int.Parse(sbNumber2.ToString());
                            switch (chOperand)
                            {
                                case '+':
                                    outputResult = x + y;
                ...
                {
                    case "+":
                        outputResult = int.Parse(sbNumber1.ToString()) + outputResult;
                        break;
                    case "-":
                        outputResult = int.Parse(sbNumber1.ToString()) - outputResult;
                        break;
            ...
            else
            {
                ...
                {
                    case "+":
                        outputResult = int.Parse(sbNumber1.ToString()) + int.Parse(sbNumber2.ToString());
                        break;
                    case "-":
                        outputResult = int.Parse(sbNumber1.ToString()) - int.Parse(sbNumber2.ToString());
                        break;
